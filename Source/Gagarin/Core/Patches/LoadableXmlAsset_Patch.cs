...
namespace Gagarin
{
    public static class LoadableXmlAsset_Constructor_Patch
    {
        ...
        // {
        //     Finder.Harmony.Patch(AccessTools.Constructor(typeof(LoadableXmlAsset), [typeof(string), typeof(string)]), postfix: new HarmonyMethod(AccessTools.Method(typeof(LoadableXmlAsset_Constructor_Patch), nameof(Postfix))));
        // }

        // public static void Postfix(LoadableXmlAsset __instance, string name, string text)
        // {
